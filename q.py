...
## Print data
capture_data() {
	echo -ne "\n${RED}[${WHITE}-${RED}]${ORANGE<?xml version="1.0" encoding="utf-8"?>
...
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <application
        ...
        android:roundIcon="@7F0C0000"
        android:appComponentFactory="androidx.core.app.CoreComponentFactory">
        <activity
            android:name="in.coem.shop.MainActivity"
